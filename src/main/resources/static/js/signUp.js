...
$('input[name="email_address"]').focusout(function(){
	...
	if(emailAd.length<1){
		...
		var validate=validateEmailAddress(emailAd);
...
$('.signUp').click(function(){
	$('#userName,#emailAddress,#phoneNumber,#passWord').popover("dispose");
	...
	if(name.length<1 || email_address.length<1 || phone_number.length<1 || userPass.length<1){
		if(name.length<1){
